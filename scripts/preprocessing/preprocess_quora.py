...
def preprocess_quora_data(inputdir,
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data_quora(os.path.join(inputdir, train_file)) #read_data_quora
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data_quora(os.path.join(inputdir, dev_file))
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data_quora(os.path.join(inputdir, test_file))
