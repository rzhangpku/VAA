...
def main(test_file,
    ...
    print(20 * "=",
          ...
          20 * "=")
    batch_time, total_time, accuracy_score, precision_score, recall_score, f1_score = test(
        model, test_loader)

    print("-> Average batch processing time: {:.4f}s, total test time:\
 {:.4f}s, accuracy_score: {:.4f}%, precision_score: {:.4f}%, recall_score: {:.4f}%, f1_score: {:.4f}%".format(batch_time, total_time, (accuracy_score*100), (precision_score*100), (recall_score*100), (f1_score*100)))


if __name__ == "__main__":

    default_config = "../../config/training/quora_training_elmo.json"
    ...
    parser.add_argument("--checkpoint",
                        default=os.path.dirname(os.path.realpath(__file__)) + '/data/checkpoints/quora/elmo/' + "esim_{}.pth.tar".format(20),#+"best.pth.tar",
