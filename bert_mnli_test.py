...
if __name__ == "__main__":
    default_config = "../../config/training/mnli_testing_bert.json"
    ...
    parser.add_argument("--checkpoint",
                        default=os.path.dirname(os.path.realpath(__file__)) + '/data/checkpoints/MNLI/bert/' +"best.pth.tar",#.format(1),
