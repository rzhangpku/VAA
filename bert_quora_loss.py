...
def main(train_file,
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        all_loss_dataframe.to_csv('csv/'+str(epoch)+'.csv')
        ...
        torch.save({"epoch": epoch,
                   ...
                   os.path.join(target_dir, "loss_{}.pth.tar".format(epoch)))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint",
                        default=None,#os.path.dirname(os.path.realpath(__file__)) + '/data/checkpoints/quora/bert/' +"esim_{}.pth.tar".format(7),
