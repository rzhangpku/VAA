...
def main(train_file,
    ...
    _, valid_loss, valid_accuracy = validate(model,
                                             test_loader,
                                             criterion)
    print("\t* Mismatched loss before training: {:.4f}, accuracy: {:.4f}%"
          .format(valid_loss, (valid_accuracy*100)))
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        print("-> Mismatched. time: {:.4f}s, loss: {:.4f}, accuracy: {:.4f}%\n"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_model1",
                        default=None,#os.path.dirname(os.path.realpath(__file__)) + '/data/checkpoints/MNLI/' +"esim_model1{}.pth.tar".format(9),
                        help="Path to a checkpoint file to resume training")
