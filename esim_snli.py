...
def main(train_file,
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=lr)  # Adam, lr
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        print("-> Valid Matched. time: {:.4f}s, loss: {:.4f}, accuracy: {:.4f}%\n"
              .format(epoch_time, epoch_loss, (epoch_accuracy*100)))
        ...
        print("-> Valid Mismatched. time: {:.4f}s, loss: {:.4f}, accuracy: {:.4f}%\n"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint",
                        default=os.path.dirname(os.path.realpath(__file__)) + '/data/checkpoints/SNLI/' +'best.pth.tar',#+"esim_{}.pth.tar".format(3),
